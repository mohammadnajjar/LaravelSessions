...
/**
 * 
	بفيدني لما بدي اعمل اعادة توجيه للراوت او بدي ارجع استخدمو في الفيو يعني لما بدي اكتبو جوا رابط مافي داعي اكتب المسار بتخصر بكتب فقط متل المثال تحت داخل الفيو فهو يسمح بإنشاء عمليات إعادة توجيه ملائمة أو انشاء مسار محدد
	ملاحظة:
